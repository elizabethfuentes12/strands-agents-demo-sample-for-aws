#!/usr/bin/env python3
"""CDK app: Strands Agents demo showcase — backend.

Stacks:
- StrandsDemosBaseStack: Cognito + AppSync Events API + dispatcher Lambda.
- StrandsDemo01Stack .. StrandsDemo11Stack: one AgentCore Runtime per demo.
"""
import os

import aws_cdk as cdk

from backend.base_stack import BaseStack
from backend.demo_stack import DemoStack
